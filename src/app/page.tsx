          ...
          >
            <div className="p-12 md:p-20">
              ...
              >
                ...
                <p className="text-2xl mb-12 text-gray-100">Start making predictions and earning Fan Tokens with Pepper today!</p>
                <motion.div
      ...
      >
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-white">Welcome to Pepper</p>
          </div>
        </div>
      </motion.div>
    </div>
