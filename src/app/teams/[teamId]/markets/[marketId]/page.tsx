...
const contractABI = [
    ...
    "outputs": [
      {
        "components": [
          ...
          { "internalType": "enum Pepper.MarketStatus", "name": "status", "type": "uint8" },
          { "internalType": "uint256", "name": "resolvedOutcomeIndex", "type": "uint256" }
        ],
        "internalType": "struct Pepper.Market",
        "name": "",
        "type": "tuple"
      }
    ],
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "enum Pepper.OrderType", "name": "_orderType", "type": "uint8" },
    ...
    "outputs": [
      {
        "components": [
          ...
          { "internalType": "enum Pepper.OrderType", "name": "orderType", "type": "uint8" }
        ],
        "internalType": "struct Pepper.Bet",
        "name": "",
        "type": "tuple"
      }
    ],
